			...
			<div class="payouts-wrapper">
				...
				>
					<div class="child-left">
						...
						>
							<img src="../../../../styles/img/symbol_logo_white_aw.png" style="height: 14px" title="LARED" />
					...
					>
						<img src="../../../../styles/img/symbol_logo_white_aw.png" style="height: 14px" title="LARED NIS1"/>
